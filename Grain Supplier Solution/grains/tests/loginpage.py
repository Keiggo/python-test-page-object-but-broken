...
class LoginPage(BasePage):
    ...
    def checkLoginPageElementsInRightOrder(self):
        listOfElementsInOrder = LoginPage.listOfElementsInOrder(self)
        BasePage.checkElementTabOrder(self, listOfElementsInOrder)